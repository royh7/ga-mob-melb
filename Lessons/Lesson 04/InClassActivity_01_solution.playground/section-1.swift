...
Example:
    func calculateDistanceBetweenCities(departureCity:String, destinationCity:string) {
        ...
        print("The distance between \(departureCity) and \(destinationCity) is \(magicalDistance)")
    }
...
// Call replyWhoIsHere
replyWhoIsHere("Thomas", homeCountry: "Mars")

// Call tellNameAndAge
tellNameAndAge("Thomas", birthYear: 1992)
